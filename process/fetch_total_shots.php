...
// Count total rows
$countSql = "SELECT COUNT(*) AS total FROM [secondary_dashboard_db].[dbo].[sp_total_shots] $whereSQL";
...
$sql = "
    SELECT [section]
      ...
      ,[gomusen_insertion]
          ...
          ,[shift]
    FROM [secondary_dashboard_db].[dbo].[sp_total_shots]
    $whereSQL
    ORDER BY [section]
";

$stmt = sqlsrv_query($conn, $sql, $whereParams);
$data = [];
if ($stmt !== false) {
