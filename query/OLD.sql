...
ISNULL([Intermediatetripping(KB10)NSC/Weld], 0) AS intermediate_stripping_kb10_nsc_weld,
...
ISNULL([Intermediatetripping(KB10)NSC/Weld], 0) +
...
'Intermediatetripping(KB10)NSC/Weld',
...
SUM(ISNULL([Intermediatetripping(KB10)NSC/Weld], 0)),
...
SUM(CASE WHEN [process] = 'Intermediatetripping(KB10)NSC/Weld' THEN [daily_result] ELSE 0 END) AS intermediate_stripping_kb10_nsc_weld,
...
ActualOutput AS (
    SELECT 
        REPLACE([section], 'Section ', '') AS section,
        'Actual Output' AS general_process,
SUM(CASE WHEN [process] = 'UV-III' THEN [daily_result] ELSE 0 END) AS uv_iii,
SUM(CASE WHEN [process] = 'Arc Welding' THEN [daily_result] ELSE 0 END) AS arc_welding,
SUM(CASE WHEN [process] = 'Aluminum Coating UV II' THEN [daily_result] ELSE 0 END) AS aluminum_coating_uv_ii,
SUM(CASE WHEN [process] = 'Servo Crimping' THEN [daily_result] ELSE 0 END) AS servo_crimping,
...
ISNULL(CEILING(p.uv_iii/ NULLIF(t.uv_iii* 15.0, 0)), 0) AS uv_iii,
ISNULL(CEILING(p.arc_welding/ NULLIF(t.arc_welding* 15.0, 0)), 0) AS arc_welding,
ISNULL(CEILING(p.aluminum_coating_uv_ii/ NULLIF(t.aluminum_coating_uv_ii* 15.0, 0)), 0) AS aluminum_coating_uv_ii,
ISNULL(CEILING(p.servo_crimping/ NULLIF(t.servo_crimping* 15.0, 0)), 0) AS servo_crimping,
ISNULL(CEILING(p.ultrasonic_welding/ NULLIF(t.ultrasonic_welding* 15.0, 0)), 0) AS ultrasonic_welding,
ISNULL(CEILING(p.cap_insertion/ NULLIF(t.cap_insertion* 15.0, 0)), 0) AS cap_insertion,
ISNULL(CEILING(p.twisting_primary_aluminum/ NULLIF(t.twisting_primary_aluminum* 15.0, 0)), 0) AS twisting_primary_aluminum,
ISNULL(CEILING(p.twisting_secondary_aluminum/ NULLIF(t.twisting_secondary_aluminum* 15.0, 0)), 0) AS twisting_secondary_aluminum,
ISNULL(CEILING(p.airbag/ NULLIF(t.airbag* 15.0, 0)), 0) AS airbag,
ISNULL(CEILING(p.a_b_sub_pc/ NULLIF(t.a_b_sub_pc* 15.0, 0)), 0) AS a_b_sub_pc,
ISNULL(CEILING(p.manual_insertion_to_connector/ NULLIF(t.manual_insertion_to_connector* 15.0, 0)), 0) AS manual_insertion_to_connector,
ISNULL(CEILING(p.v_type_twisting/ NULLIF(t.v_type_twisting* 15.0, 0)), 0) AS v_type_twisting,
ISNULL(CEILING(p.twisting_primary/ NULLIF(t.twisting_primary* 15.0, 0)), 0) AS twisting_primary,
ISNULL(CEILING(p.twisting_secondary/ NULLIF(t.twisting_secondary* 15.0, 0)), 0) AS twisting_secondary,
ISNULL(CEILING(p.manual_crimping_2tons/ NULLIF(t.manual_crimping_2tons* 15.0, 0)), 0) AS manual_crimping_2tons,
ISNULL(CEILING(p.manual_crimping_4tons/ NULLIF(t.manual_crimping_4tons* 15.0, 0)), 0) AS manual_crimping_4tons,
ISNULL(CEILING(p.manual_crimping_5tons/ NULLIF(t.manual_crimping_5tons* 15.0, 0)), 0) AS manual_crimping_5tons,
ISNULL(CEILING(p.intermediate_ripping_uas_manual_nf_f/ NULLIF(t.intermediate_ripping_uas_manual_nf_f* 15.0, 0)), 0) AS intermediate_ripping_uas_manual_nf_f,
ISNULL(CEILING(p.intermediate_ripping_uas_joint/ NULLIF(t.intermediate_ripping_uas_joint* 15.0, 0)), 0) AS intermediate_ripping_uas_joint,
ISNULL(CEILING(p.intermediate_stripping_kb10/ NULLIF(t.intermediate_stripping_kb10* 15.0, 0)), 0) AS intermediate_stripping_kb10,
ISNULL(CEILING(p.intermediate_stripping_kb10_nsc_weld/ NULLIF(t.intermediate_stripping_kb10_nsc_weld* 15.0, 0)), 0) AS intermediate_stripping_kb10_nsc_weld,
ISNULL(CEILING(p.joint_crimping_2_tons/ NULLIF(t.joint_crimping_2_tons* 15.0, 0)), 0) AS joint_crimping_2_tons,
ISNULL(CEILING(p.joint_crimping_4TONS_ps_200/ NULLIF(t.joint_crimping_4TONS_ps_200* 15.0, 0)), 0) AS joint_crimping_4TONS_ps_200,
ISNULL(CEILING(p.joint_crimping_5tons/ NULLIF(t.joint_crimping_5tons* 15.0, 0)), 0) AS joint_crimping_5tons,
ISNULL(CEILING(p.manual_taping_dispenser/ NULLIF(t.manual_taping_dispenser* 15.0, 0)), 0) AS manual_taping_dispenser,
ISNULL(CEILING(p.joint_taping/ NULLIF(t.joint_taping* 15.0, 0)), 0) AS joint_taping,
ISNULL(CEILING(p.intermediate_welding/ NULLIF(t.intermediate_welding* 15.0, 0)), 0) AS intermediate_welding,
ISNULL(CEILING(p.intermediate_welding_0_13 / NULLIF(t.intermediate_welding_0_13 * 15.0, 0)), 0) AS intermediate_welding_0_13,
ISNULL(CEILING(p.welding_at_head/ NULLIF(t.welding_at_head* 15.0, 0)), 0) AS welding_at_head,
ISNULL(CEILING(p.welding_at_head_0_13/ NULLIF(t.welding_at_head_0_13* 15.0, 0)), 0) AS welding_at_head_0_13,
ISNULL(CEILING(p.silicon_injection/ NULLIF(t.silicon_injection* 15.0, 0)), 0) AS silicon_injection,
ISNULL(CEILING(p.welding_cap_insertion/ NULLIF(t.welding_cap_insertion* 15.0, 0)), 0) AS welding_cap_insertion,
ISNULL(CEILING(p.welding_taping_13mm/ NULLIF(t.welding_taping_13mm* 15.0, 0)), 0) AS welding_taping_13mm,
ISNULL(CEILING(p.heat_shrink/ NULLIF(t.heat_shrink* 15.0, 0)), 0) AS heat_shrink,
ISNULL(CEILING(p.heat_shrink_la_terminal/ NULLIF(t.heat_shrink_la_terminal* 15.0, 0)), 0) AS heat_shrink_la_terminal,
ISNULL(CEILING(p.heat_shrink_joint_crimping/ NULLIF(t.heat_shrink_joint_crimping* 15.0, 0)), 0) AS heat_shrink_joint_crimping,
ISNULL(CEILING(p.heat_shrink_welding/ NULLIF(t.heat_shrink_welding* 15.0, 0)), 0) AS heat_shrink_welding,
ISNULL(CEILING(p.casting_c385/ NULLIF(t.casting_c385* 15.0, 0)), 0) AS casting_c385,
ISNULL(CEILING(p.stmac_shieldwire_nissan/ NULLIF(t.stmac_shieldwire_nissan* 15.0, 0)), 0) AS stmac_shieldwire_nissan,
ISNULL(CEILING(p.quick_stripping/ NULLIF(t.quick_stripping* 15.0, 0)), 0) AS quick_stripping,
ISNULL(CEILING(p.manual_heat_shrink_blower_sumitube/ NULLIF(t.manual_heat_shrink_blower_sumitube* 15.0, 0)), 0) AS manual_heat_shrink_blower_sumitube,
ISNULL(CEILING(p.drainwire_tip/ NULLIF(t.drainwire_tip* 15.0, 0)), 0) AS drainwire_tip,
ISNULL(CEILING(p.manual_crimping_shieldwire/ NULLIF(t.manual_crimping_shieldwire* 15.0, 0)), 0) AS manual_crimping_shieldwire,
ISNULL(CEILING(p.joint_crimping_2_tons_sw/ NULLIF(t.joint_crimping_2_tons_sw* 15.0, 0)), 0) AS joint_crimping_2_tons_sw,
ISNULL(CEILING(p.manual_blue_taping_dispenser_sw/ NULLIF(t.manual_blue_taping_dispenser_sw* 15.0, 0)), 0) AS manual_blue_taping_dispenser_sw,
ISNULL(CEILING(p.shieldwire_taping/ NULLIF(t.shieldwire_taping* 15.0, 0)), 0) AS shieldwire_taping,
ISNULL(CEILING(p.hs_components_insertion_sw/ NULLIF(t.hs_components_insertion_sw* 15.0, 0)), 0) AS hs_components_insertion_sw,
ISNULL(CEILING(p.heat_shrink_joint_crimping_sw/ NULLIF(t.heat_shrink_joint_crimping_sw* 15.0, 0)), 0) AS heat_shrink_joint_crimping_sw,
ISNULL(CEILING(p.waterproof_pad_press/ NULLIF(t.waterproof_pad_press* 15.0, 0)), 0) AS waterproof_pad_press,
ISNULL(CEILING(p.low_viscosity/ NULLIF(t.low_viscosity* 15.0, 0)), 0) AS low_viscosity,
ISNULL(CEILING(p.air_water_leak_test/ NULLIF(t.air_water_leak_test* 15.0, 0)), 0) AS air_water_leak_test,
ISNULL(CEILING(p.hirose/ NULLIF(t.hirose* 15.0, 0)), 0) AS hirose,
ISNULL(CEILING(p.casting_battery/ NULLIF(t.casting_battery* 15.0, 0)), 0) AS casting_battery,
ISNULL(CEILING(p.stmac_aluminum/ NULLIF(t.stmac_aluminum* 15.0, 0)), 0) AS stmac_aluminum,
ISNULL(CEILING(p.manual_crimping_20tons/ NULLIF(t.manual_crimping_20tons* 15.0, 0)), 0) AS manual_crimping_20tons,
ISNULL(CEILING(p.manual_heat_shrink_blower_battery/ NULLIF(t.manual_heat_shrink_blower_battery* 15.0, 0)), 0) AS manual_heat_shrink_blower_battery,
ISNULL(CEILING(p.joint_crimping_20tons/ NULLIF(t.joint_crimping_20tons* 15.0, 0)), 0) AS joint_crimping_20tons,
ISNULL(CEILING(p.dip_soldering_battery/ NULLIF(t.dip_soldering_battery* 15.0, 0)), 0) AS dip_soldering_battery,
ISNULL(CEILING(p.ultrasonic_dip_soldering_aluminum/ NULLIF(t.ultrasonic_dip_soldering_aluminum* 15.0, 0)), 0) AS ultrasonic_dip_soldering_aluminum,
ISNULL(CEILING(p.la_molding/ NULLIF(t.la_molding* 15.0, 0)), 0) AS la_molding,
ISNULL(CEILING(p.pressure_welding_dome_lamp/ NULLIF(t.pressure_welding_dome_lamp* 15.0, 0)), 0) AS pressure_welding_dome_lamp,
ISNULL(CEILING(p.ferrule_process/ NULLIF(t.ferrule_process* 15.0, 0)), 0) AS ferrule_process,
ISNULL(CEILING(p.gomusen_insertion/ NULLIF(t.gomusen_insertion* 15.0, 0)), 0) AS gomusen_insertion,
ISNULL(CEILING(p.point_marking/ NULLIF(t.point_marking* 15.0, 0)), 0) AS point_marking,
        ...
        -- Total
         ...
         ISNULL(CEILING(p.uv_iii/ NULLIF(t.uv_iii* 15.0, 0)), 0) +
ISNULL(CEILING(p.arc_welding/ NULLIF(t.arc_welding* 15.0, 0)), 0) +
ISNULL(CEILING(p.aluminum_coating_uv_ii/ NULLIF(t.aluminum_coating_uv_ii* 15.0, 0)), 0) +
ISNULL(CEILING(p.servo_crimping/ NULLIF(t.servo_crimping* 15.0, 0)), 0) +
ISNULL(CEILING(p.ultrasonic_welding/ NULLIF(t.ultrasonic_welding* 15.0, 0)), 0) +
ISNULL(CEILING(p.cap_insertion/ NULLIF(t.cap_insertion* 15.0, 0)), 0) +
ISNULL(CEILING(p.twisting_primary_aluminum/ NULLIF(t.twisting_primary_aluminum* 15.0, 0)), 0) +
ISNULL(CEILING(p.twisting_secondary_aluminum/ NULLIF(t.twisting_secondary_aluminum* 15.0, 0)), 0) +
ISNULL(CEILING(p.airbag/ NULLIF(t.airbag* 15.0, 0)), 0) +
ISNULL(CEILING(p.a_b_sub_pc/ NULLIF(t.a_b_sub_pc* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_insertion_to_connector/ NULLIF(t.manual_insertion_to_connector* 15.0, 0)), 0) +
ISNULL(CEILING(p.v_type_twisting/ NULLIF(t.v_type_twisting* 15.0, 0)), 0) +
ISNULL(CEILING(p.twisting_primary/ NULLIF(t.twisting_primary* 15.0, 0)), 0) +
ISNULL(CEILING(p.twisting_secondary/ NULLIF(t.twisting_secondary* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_crimping_2tons/ NULLIF(t.manual_crimping_2tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_crimping_4tons/ NULLIF(t.manual_crimping_4tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_crimping_5tons/ NULLIF(t.manual_crimping_5tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_ripping_uas_manual_nf_f/ NULLIF(t.intermediate_ripping_uas_manual_nf_f* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_ripping_uas_joint/ NULLIF(t.intermediate_ripping_uas_joint* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_stripping_kb10/ NULLIF(t.intermediate_stripping_kb10* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_stripping_kb10_nsc_weld/ NULLIF(t.intermediate_stripping_kb10_nsc_weld* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_crimping_2_tons/ NULLIF(t.joint_crimping_2_tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_crimping_4TONS_ps_200/ NULLIF(t.joint_crimping_4TONS_ps_200* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_crimping_5tons/ NULLIF(t.joint_crimping_5tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_taping_dispenser/ NULLIF(t.manual_taping_dispenser* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_taping/ NULLIF(t.joint_taping* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_welding/ NULLIF(t.intermediate_welding* 15.0, 0)), 0) +
ISNULL(CEILING(p.intermediate_welding_0_13 / NULLIF(t.intermediate_welding_0_13 * 15.0, 0)), 0)  +
ISNULL(CEILING(p.welding_at_head/ NULLIF(t.welding_at_head* 15.0, 0)), 0) +
ISNULL(CEILING(p.welding_at_head_0_13/ NULLIF(t.welding_at_head_0_13 * 15.0, 0)), 0) +
ISNULL(CEILING(p.silicon_injection/ NULLIF(t.silicon_injection* 15.0, 0)), 0) +
ISNULL(CEILING(p.welding_cap_insertion/ NULLIF(t.welding_cap_insertion* 15.0, 0)), 0) +
ISNULL(CEILING(p.welding_taping_13mm/ NULLIF(t.welding_taping_13mm* 15.0, 0)), 0) +
ISNULL(CEILING(p.heat_shrink/ NULLIF(t.heat_shrink* 15.0, 0)), 0) +
ISNULL(CEILING(p.heat_shrink_la_terminal/ NULLIF(t.heat_shrink_la_terminal* 15.0, 0)), 0) +
ISNULL(CEILING(p.heat_shrink_joint_crimping/ NULLIF(t.heat_shrink_joint_crimping* 15.0, 0)), 0) +
ISNULL(CEILING(p.heat_shrink_welding/ NULLIF(t.heat_shrink_welding* 15.0, 0)), 0) +
ISNULL(CEILING(p.casting_c385/ NULLIF(t.casting_c385* 15.0, 0)), 0) +
ISNULL(CEILING(p.stmac_shieldwire_nissan/ NULLIF(t.stmac_shieldwire_nissan* 15.0, 0)), 0) +
ISNULL(CEILING(p.quick_stripping/ NULLIF(t.quick_stripping* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_heat_shrink_blower_sumitube/ NULLIF(t.manual_heat_shrink_blower_sumitube* 15.0, 0)), 0) +
ISNULL(CEILING(p.drainwire_tip/ NULLIF(t.drainwire_tip* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_crimping_shieldwire/ NULLIF(t.manual_crimping_shieldwire* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_crimping_2_tons_sw/ NULLIF(t.joint_crimping_2_tons_sw* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_blue_taping_dispenser_sw/ NULLIF(t.manual_blue_taping_dispenser_sw* 15.0, 0)), 0) +
ISNULL(CEILING(p.shieldwire_taping/ NULLIF(t.shieldwire_taping* 15.0, 0)), 0) +
ISNULL(CEILING(p.hs_components_insertion_sw/ NULLIF(t.hs_components_insertion_sw* 15.0, 0)), 0) +
ISNULL(CEILING(p.heat_shrink_joint_crimping_sw/ NULLIF(t.heat_shrink_joint_crimping_sw* 15.0, 0)), 0) +
ISNULL(CEILING(p.waterproof_pad_press/ NULLIF(t.waterproof_pad_press* 15.0, 0)), 0) +
ISNULL(CEILING(p.low_viscosity/ NULLIF(t.low_viscosity* 15.0, 0)), 0) +
ISNULL(CEILING(p.air_water_leak_test/ NULLIF(t.air_water_leak_test* 15.0, 0)), 0) +
ISNULL(CEILING(p.hirose/ NULLIF(t.hirose* 15.0, 0)), 0) +
ISNULL(CEILING(p.casting_battery/ NULLIF(t.casting_battery* 15.0, 0)), 0) +
ISNULL(CEILING(p.stmac_aluminum/ NULLIF(t.stmac_aluminum* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_crimping_20tons/ NULLIF(t.manual_crimping_20tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.manual_heat_shrink_blower_battery/ NULLIF(t.manual_heat_shrink_blower_battery* 15.0, 0)), 0) +
ISNULL(CEILING(p.joint_crimping_20tons/ NULLIF(t.joint_crimping_20tons* 15.0, 0)), 0) +
ISNULL(CEILING(p.dip_soldering_battery/ NULLIF(t.dip_soldering_battery* 15.0, 0)), 0) +
ISNULL(CEILING(p.ultrasonic_dip_soldering_aluminum/ NULLIF(t.ultrasonic_dip_soldering_aluminum* 15.0, 0)), 0) +
ISNULL(CEILING(p.la_molding/ NULLIF(t.la_molding* 15.0, 0)), 0) +
ISNULL(CEILING(p.pressure_welding_dome_lamp/ NULLIF(t.pressure_welding_dome_lamp* 15.0, 0)), 0) +
ISNULL(CEILING(p.ferrule_process/ NULLIF(t.ferrule_process* 15.0, 0)), 0) +
ISNULL(CEILING(p.gomusen_insertion/ NULLIF(t.gomusen_insertion* 15.0, 0)), 0) +
ISNULL(CEILING(p.point_marking/ NULLIF(t.point_marking* 15.0, 0)), 0) +


         ISNULL(CEILING(p.a_b_sub_pc / NULLIF(t.a_b_sub_pc * 15.0, 0)), 0) AS Total
    FROM 
        PlanOutput p
    JOIN 
        TargetJPH t ON p.section = t.section
),
 PlanPerMachine AS (
    SELECT 
        p.section,
...
Combined AS (
   ...
   SELECT * FROM WIP
   UNION ALL
   SELECT * FROM PlanPerMachine -- ✅ Add this here
)
Select*
FROM Combined
ORDER BY 
