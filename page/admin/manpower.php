          ...
          <div class="card card-gray-dark card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                <div class="info">
                  <span class="d-block" id="username"><?= htmlspecialchars(strtoupper($_SESSION['username'])); ?></span>
                </div>
              </h3>
            ...
            <div class="card-body">
              ...
              <div class="row mt-1 align-items-center">
                ...
                <!-- Export Button -->
                <div class="col-md-2 d-flex justify-content-center">
                  <button class="btn btn-secondary custom-btn" id="exportBtn" style="height: 35px; width: 100%;">
                ...
                <div class="col-md-2 d-flex justify-content-center">
                  <button class="btn btn-primary custom-btn" id="generateBtn" data-toggle="modal"
                    data-target="#shiftModal" style="height: 35px; width: 100%;">
                    <i class="fas fa-cogs mr-2"></i>Generate
                  </button>
                </div>
                <div class="col-md-2 d-flex justify-content-center">
                  <button class="btn btn-info custom-btn" id="referenceBtn" data-toggle="modal"
                    data-target="#referenceModal" style="height: 35px; width: 100%;">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <div id="shiftToggle" class="my-3 p-3 rounded"
          style="cursor:pointer; width: 150px; margin: auto; font-weight: bold;">
          Loading...
        </div>
        <!-- <p>
