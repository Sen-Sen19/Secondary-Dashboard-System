...
function populateTable(data) {
    ...
    data.forEach(item => {
        ...
        // Adjust the number of cells and content according to your actual structure
        row.innerHTML = `
...
function populateTable(data) {
    ...
    data.forEach(row => {
        ...
        sectionCell.textContent = row.section; // Section
...
$(document).ready(function() {
    ...
    $('#admin_body').on('click', 'tr', function(e) {
        ...
        const username = cells[0].textContent.trim(); // Username from the third column
        const section = cells[1].textContent.trim(); // Section from the fourth column
        const password = cells[2].textContent.trim(); // Password from the fifth column
        const type = cells[3].textContent.trim(); // Type from the sixth column
